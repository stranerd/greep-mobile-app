...
class OrdersNewScreen extends StatefulWidget {
  const OrdersNewScreen({Key? key}) : super(key: key);

  @override
  _OrdersNewScreenState createState() => _OrdersNewScreenState();
}

class _OrdersNewScreenState extends State<OrdersNewScreen> {
  @override
        ...
        if (orderState is OrderListStateFetched) {
          if (orderState.orders.isEmpty) {
            return EmptyResultWidget2(
              ...
              subtitle:
              "No new orders nearby. Please try again later",
            );
          }
